...
import ModalNovoItemEstoque from './ModalNovoItemEstoque'; 
import ModalConfirmarExclusao from './ModalConfirmarExclusao'; 

// DADOS FICTÍCIOS INICIAIS
const dadosIniciais = [
  { id: 1, nome: 'Papel Couché 250g A3', categoria: 'Matéria-Prima', quantidade: 500, estoque_minimo: 100, unidade_medida: 'fls', codigo_barras: '7891234560012' },
  { id: 2, nome: 'Tinta Magenta Eco-Solvente', categoria: 'Matéria-Prima', quantidade: 2, estoque_minimo: 5, unidade_medida: 'L', codigo_barras: '7891234560029' },
  { id: 3, nome: 'Adesivo Vinil Branco Brilho', categoria: 'Matéria-Prima', quantidade: 25, estoque_minimo: 10, unidade_medida: 'm', codigo_barras: null },
  { id: 4, nome: 'Camiseta Algodão Branca M', categoria: 'Produto Acabado', quantidade: 0, estoque_minimo: 15, unidade_medida: 'un', codigo_barras: '7891234560036' },
];
...
export default function Estoque() {
  ...
  // Usando dados fictícios em vez do Supabase
  const [itens, setItens] = useState(dadosIniciais);

  // Adiciona o item fictício na lista
  ...
  const itensCriticos = itens.filter(i => i.quantidade <= i.estoque_minimo).length;
          ...
          <table className="w-full text-left text-sm text-slate-600">
            <thead className="bg-slate-50 text-slate-500 font-medium border-b border-slate-200">
              <tr>
                ...
                <th className="px-6 py-4">Cód. Barras</th> {/* NOVA COLUNA */}
